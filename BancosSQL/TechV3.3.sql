...
--
-- Host: 127.0.0.1
-- Generation Time: 18-Fev-2019 às 14:38
...
INSERT INTO `empresa` (`idemp`, `username`, `cnpj`, `senha`, `endereco`, `email`, `fund`, `creat`, `telefone`, `sobre`, `nome`, `estado`, `bairro`, `cidade`, `b_image`) VALUES
(1, 'TechFix', '123', '123', 'rua', 'fix@tech.com', '', '', '', '', '', '', '', '', '936607.jpg'),
(2, 'Android', '874521', 'senha', 'ender', 'Android@gmail.com', '', '2004', '228574', 'uma empresa', '', '', 'algum', 'Ohio', '311301.jpg'),
(3, 'Google Company', '78541', 'senha', 'Rua nenhuma', 'Gmail@gmail.com', 'Gabriel', '20/10/1995', '32888541', 'Empresa voltada para monopÃ³lio da informaÃ§Ã£o e vigiar cada um de seus usuÃ¡rios', '', '', '18', 'QuissamÃ£', '');
...
INSERT INTO `image` (`id`, `b_image`, `fk_idemp`) VALUES
(1, '668970.jpg', '1'),
(2, '773556.jpg', '2'),
(3, '140814.jpg', '3'),
(4, '330151.jpg', '1'),
...
INSERT INTO `servico` (`serv`, `descr`, `preco`, `id_serv`, `fkemp`, `s_image`) VALUES
('REVISÃO', 'destruirpc', '40', 1, '1', 'funciona.jpg'),
('SOFTWARE', 'mudar', '60', 2, '2', '68364.jpg');
