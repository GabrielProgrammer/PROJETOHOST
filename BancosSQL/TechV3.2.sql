...
--
-- Host: 127.0.0.1
-- Generation Time: 16-Fev-2019 às 14:25
...
(2, 'Android', '874521', 'senha', 'ender', 'Android@gmail.com', '', '2004', '228574', 'uma empresa', '', '', 'algum', 'Ohio'),
...
('Conserto de notebooks', 'Consertamos a partir de 100 pra fazer nada ', '5', 20, '1'),
('tickets', 'cinema', '45', 21, '3'),
('tickets', 'cinema', '45', 22, '3'),
('nein', 'nein', 'nein', 23, '3'),
('c', 'c', 'c', 24, '3'),
('c', 'c', 'c', 25, '3'),
('njnjk', 'jkijo', 'oiji', 26, '3'),
('nada', 'aaaaa', '53', 27, '1');
...
--
ALTER TABLE `servico`
  MODIFY `id_serv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
